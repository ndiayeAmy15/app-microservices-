...
@RestController
@RequestMapping("/api/ms-1-kafka")
public class Ms1KafkaResource {

    private static final String PRODUCER_BINDING_NAME = "binding-out-0";

    private static final Logger LOG = LoggerFactory.getLogger(Ms1KafkaResource.class);
    private final KafkaConsumer kafkaConsumer;
    private final StreamBridge streamBridge;

    public Ms1KafkaResource(StreamBridge streamBridge, KafkaConsumer kafkaConsumer) {
