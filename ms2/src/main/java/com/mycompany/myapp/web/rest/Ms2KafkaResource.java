...
@RestController
@RequestMapping("/api/ms-2-kafka")
public class Ms2KafkaResource {

    private static final String PRODUCER_BINDING_NAME = "binding-out-0";

    private static final Logger LOG = LoggerFactory.getLogger(Ms2KafkaResource.class);
    private final KafkaConsumer kafkaConsumer;
    private final StreamBridge streamBridge;

    public Ms2KafkaResource(StreamBridge streamBridge, KafkaConsumer kafkaConsumer) {
